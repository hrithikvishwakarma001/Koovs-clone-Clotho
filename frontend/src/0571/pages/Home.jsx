...
const Home = () => {
  ...
  const women = products.slice(82, 86)
  const men = products.slice(10, 14)
  const newarrival = products.slice(15, 23)
  const artistedit = products.slice(25, 34)
  const artistedit2 = products.slice(35, 40)
  const artistedit3 = products.slice(42, 46)


  const newarrival2 = products.slice(35, 43)
  const ExploreKoovsWomens = products.slice(85, 93)
  const ExploreBrandsKoovsPart = products.slice(94, 102)
  //console.log(women,"kk")
  useEffect(() => {
    getdata()
  }, [])
  ...
  return (
    <>
      ...
      <Box marginTop={"15px"} >
        ...
        <Box height="auto" padding="20px" paddingTop={"0px"} >
          <SimpleGrid margin="auto" columns={{ sm: 1, md: 2, lg: 4 }} gap="40px" >
            ...
            {women.map((e, index) => <Box onClick={() => navigate(`/details/${e._id}`)} key={index} _hover={{ transform: "scale(0.95)", transition: "all .5s", cursor: "pointer" }}>
        ...
        <Box height="auto" padding="20px" paddingTop={"0px"} >
          <SimpleGrid margin="auto" columns={{ sm: 1, md: 2, lg: 4 }} gap="40px">
            ...
            {men.map((e, index) => <Box onClick={() => navigate(`/details/${e._id}`)} key={index} _hover={{ transform: "scale(0.95)", transition: "all .5s", cursor: "pointer" }} >
              <img style={{ width: "100%" }} src={e.image[0].src} />
      ...
      <Box className='data' height="auto" padding="38px" paddingTop={"0px"} gap="0px"


      >
        <SimpleGrid margin="auto" columns={{ sm: 1, md: 2, lg: 4 }} gap="40px" >

          {newarrival.map((e, index) =>
      ...
      {data ? <Box w="100%" paddingTop="10px">
        ...
        <Carousel responsive={responsive}>
          ...
          {artistedit.map((e, index) =>
            <Box onClick={() => navigate(`/details/${e._id}`)} key={index} marginTop={"30px"} width="80%" margin="auto" _hover={{ transform: "scale(1.2)", transition: "all .5s", cursor: "pointer" }}  >
      ...
      >
        <SimpleGrid margin="auto" columns={{ sm: 1, md: 2, lg: 4 }} >
          ...
          {newarrival2.map((e, index) => <Box onClick={() => navigate(`/details/${e._id}`)} key={index} _hover={{ transform: "scale(0.95)", transition: "all .5s", cursor: "pointer" }}>
      ...
      <Box margin="auto" width="95%" height="auto" padding="0px 0px" paddingTop={"0px"}


      >
        <SimpleGrid columns={{ sm: 1, md: 2, lg: 4 }} gap="27px">

          {ExploreKoovsWomens.map((e, index) => <Box onClick={() => navigate(`/details/${e._id}`)} key={index} _hover={{ transform: "scale(0.95)", transition: "all .5s", cursor: "pointer", dis: true }}>
            <img style={{ width: "100%" }} src={e.image[0].src} alt="" />
      ...
      <Box width="95%" margin="auto" height="auto" paddingTop={"0px"}


      >
        <SimpleGrid columns={{ sm: 1, md: 2, lg: 4 }} gap="27px" >

          {ExploreBrandsKoovsPart.map((e, index) => <Box onClick={() => navigate(`/details/${e._id}`)} key={index} _hover={{ transform: "scale(0.95)", transition: "all .5s", cursor: "pointer" }}>
            <img style={{ width: "100%" }} src={e.image[0].src} alt="" />
